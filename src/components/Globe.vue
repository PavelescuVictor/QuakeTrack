        ...
        isGlobeActive: function () {
            if (this.isGlobeActive === true && this.neverShowed === true) {
                ...
                this.globe
                    ...
                    .globeImageUrl(
                        "https://cors-anywhere.herokuapp.com/https://eoimages.gsfc.nasa.gov/images/imagerecords/144000/144898/BlackMarble_2016_01deg.jpg"
                    )
                    .bumpImageUrl(
                    ...
                    .hexLabel(
                        ...
                        <b>${
                            d.points.length
                        }</b> earthquakes in the past month:<ul><li>
                        ${d.points
                            .slice()
                ...
                var queryDateTime = `${queryDate.getFullYear()}-${
                    queryDate.getMonth() + 1
                }-${queryDate.getDate()}T${queryDate.getHours()}:${queryDate.getMinutes()}:${queryDate.getSeconds()}`;
                axios
                    .get(
                        `https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=${queryDateTime}&endtime=${dateTime}`
                    )
                    .then((equakes) => {
                ...
                setTimeout(() => {
                    ...
                    const directionalLight = this.globe
                        .scene()
                        .children.find(
